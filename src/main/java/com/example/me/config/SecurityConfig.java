...
public class SecurityConfig {
    ...
    private CorsConfigurationSource getConfigurationSource() {
        ...
        config.setAllowedOriginPatterns(List.of("http://localhost:*", "http://localhost", "http://127.0.0.1:*", "http://3.128.221.93:*", "http://3.128.221.93", "http://ec2-3-128-221-93.us-east-2.compute.amazonaws.com"));
